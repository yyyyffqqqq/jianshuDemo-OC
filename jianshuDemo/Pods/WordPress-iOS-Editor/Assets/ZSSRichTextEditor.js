...
//ZSSEditor.currentFieldContentInnerHTML = []; //当前的数组元素
//ZSSEditor.deletedFieldContentInnerHTML = [];//被删除的数组元素
...
ZSSEditor.undo = function() {
    ...
    /**
     *solve document.execCommand('undo', false, null);不支持问题
     */
//    var container = document.getElementById('zss_field_content');
//    
//    if (ZSSEditor.deletedFieldContentInnerHTML.length-1 <= 0) {
//        container.innerHTML = "";
////
//        
//    } else {
//        container.innerHTML += ZSSEditor.deletedFieldContentInnerHTML[ZSSEditor.deletedFieldContentInnerHTML.length-1];
////        for (item in ZSSEditor.deletedFieldContentInnerHTML)
////        {
////            container.innerHTML += item;
////        }
////        container.innerHTML = ZSSEditor.currentFieldContentInnerHTML[ZSSEditor.currentFieldContentInnerHTML.length-1];
//        ZSSEditor.currentFieldContentInnerHTML.push(container.innerHTML);
//    }
//    
//    
//    
//    if (ZSSEditor.currentFieldContentInnerHTML.length != 0) {
//        ZSSEditor.deletedFieldContentInnerHTML.push(ZSSEditor.currentFieldContentInnerHTML[ZSSEditor.currentFieldContentInnerHTML.length-1]);
//        ZSSEditor.deletedFieldContentInnerHTML.remove(ZSSEditor.currentFieldContentInnerHTML.length-1);
//    }
...
//    var container = document.getElementById('zss_field_content');
//
//    if (ZSSEditor.deletedFieldContentInnerHTML.length != 0) {
//        ZSSEditor.currentFieldContentInnerHTML.push(ZSSEditor.currentFieldContentInnerHTML[ZSSEditor.deletedFieldContentInnerHTML.length-1]);
//        
//        for (item in ZSSEditor.currentFieldContentInnerHTML)
//        {
//            container.innerHTML += item;
//        }
//        ZSSEditor.deletedFieldContentInnerHTML.remove(ZSSEditor.deletedFieldContentInnerHTML.length-1);
//    }
