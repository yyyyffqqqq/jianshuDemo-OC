...
- (void)parseDictionary:(NSDictionary *)dict
{
    ...
    // attachmentId is.
    self.captionId = [dict objectForKey:MetaKeyCaptionId];

    self.align = [dict objectForKey:MetaKeyAlign];
    self.alt = [dict objectForKey:MetaKeyAlt];
    self.attachmentId = [dict objectForKey:MetaKeyAttachmentId];
    self.caption = [dict objectForKey:MetaKeyCaption];
    self.captionClassName = [dict objectForKey:MetaKeyCaptionClassName];
    self.classes = [dict objectForKey:MetaKeyClasses];
    self.height = [dict objectForKey:MetaKeyHeight];
    self.linkClassName = [dict objectForKey:MetaKeyLinkClassName];
    self.linkRel = [dict objectForKey:MetaKeyLinkRel];
    self.linkTargetBlank = [[dict objectForKey:MetaKeyLinkTargetBlank] boolValue];
    self.linkURL = [dict objectForKey:MetaKeyLinkUrl];
    self.size = [dict objectForKey:MetaKeySize];
    self.src = [dict objectForKey:MetaKeySrc];
    self.title = [dict objectForKey:MetaKeyTitle];
    self.width = [dict objectForKey:MetaKeyWidth];
    self.naturalWidth = [dict objectForKey:MetaKeyNaturalWidth];
    self.naturalHeight = [dict objectForKey:MetaKeyNaturalHeight];
}
